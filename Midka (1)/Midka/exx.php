...
<article class="card-body mx-auto" style="max-width: 400px;">
    ...
    <div class="form-group input-group">
		...
		<select class="custom-select" style="max-width: 80px; margin-left: 0" name="_">
		    <option selected="">+705</option>
		    <option value="1">+777</option>
		    <option value="2">+747</option>
		    <option value="3">+702</option>
		</select>
    ...
    <?php
      ...
      $contact_e = $_POST['contact'];
      $contact_n = $_POST['_'];
      $job = $_POST['job'];
      $contact = $contact_n.$contact_e;
      ...
      if(!empty($_POST["name"]) && !empty($_POST["email"]) && !empty($_POST["pass"]) && !empty($_POST["contact"])){
          ...
          $result = $mysqli->query("INSERT INTO ".$db_table." (full_name, number, email, job, pass) VALUES ('$name','$contact','$email','$job','$pass')");
      }
    ?>
