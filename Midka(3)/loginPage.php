    ...
    $link = mysqli_connect("localhost", "root", "", "web_mid");
      ...
      // Если есть ошибка соединения, выводим её и убиваем подключение
        ...
        if(!empty($_POST['email']) && !empty($_POST['pass']))
        {
            ...
            $query = mysqli_query($link,"SELECT id, email, pass, role FROM users WHERE email='".mysqli_real_escape_string($link,$_POST['email'])."' LIMIT 1");
			...
			<div class="container">
				...
				<ul class="nav nav-pills lighten-2 mx-0 mb-0 mt-0 nav-fill">
				  ...
				  <li class="nav-item">
				   ...
				   <li class="nav-item">
				    <a class="nav-link py-4 " href="loginPage.php">Sign In</a>
				  </li>
