      ...
      <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
        ...
        <p>
         <?php
            ...
            if(isset($_COOKIE['user_id'])){
                if($name['role'] == 'user'){
                    echo '<a href="find_job.php" style="text-decoration: none">Find Job</a>';
                }elseif($name['role'] == 'company'){
                    echo '<a href="#!" style="text-decoration: none">Find Worker</a>';
                }else{
                    echo '<a href="find_job.php" style="text-decoration: none">Find Job</a></p>';
                    echo '<p><a href="#!" style="text-decoration: none">Find Worker</a>';
                }
            }
